...
Your writing partner: research, outline, draft, refine content. Keeps your unique voice + style.
...
- Case studies
- Technical docs w/ sources
- Citations + references
- Hooks + introductions
- Section-by-section feedback while writing

## What This Skill Does

1. **Collaborative Outlining**: Structure ideas into coherent outlines
2. **Research Assistance**: Relevant info + citations
3. **Hook Improvement**: Stronger opening, capture attention
4. **Section Feedback**: Review each section as you write
5. **Voice Preservation**: Your style + tone
6. **Citation Management**: References properly added + formatted
...
Create dedicated folder for your article:
```
...
1. **Understand the Writing Project**
   ...
   - Existing research or sources to include?
...
- Recent data when possible
- Balance different perspectives
- Link to original sources

### For Feedback
- Be specific: "Is this too technical?"
- Share concerns: "I'm worried this section drags"
